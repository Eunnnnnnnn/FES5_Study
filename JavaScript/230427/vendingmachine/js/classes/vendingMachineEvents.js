class VendingMachineEvents {
    constructor() { // class가 교실이라면 constructor은 청소도구라 생각, 밑의 프로퍼티값이 함수인 메서드들은 청소도구를 갖고, 각자의 역할들을 맡았다고 생각.
        //html section1을 담당하도록 변수선언
